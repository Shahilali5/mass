...
async def send_messages():
    # Inicia el bot
    bot = aiogram.Bot(token='7287154113:AAHrBZykADnm82bW__LAyFyG-3oqWV-Njcg')
    chat_id = -1002178480388
    ...
    for i, line in enumerate(lines, start=1):
        ...
        button_consultas = InlineKeyboardButton("Owner", url="https://t.me/Shahil44")
        ...
        message = ""
        message += f"\n"
        message += f"<b>DevilMods</b>"
        message += "━━━━━━━━━━━━━━\n"
        message += f"<b>⌖ 𝗖𝗰 ⤳</b> <code>{linea}</code>\n"
        message += f"⌖ 𝗦𝘁𝗮𝘁𝘂𝘀 ⤳ 𝙑𝘼𝙇𝙄𝘿𝘼! ✅\n"
        message += f"⌖ 𝗕𝗶𝗻 ⤳ #Bin{BIN}\n"
        message += "━━━━━━━━━━━━━━\n"
        message += f"<b>⌮ 𝗜𝗻𝗳𝗼 ⤳ </b>  <code>{brand}-{typea}-{level}</code>\n"
        message += f"<b>⌮ 𝗕𝗮𝗻𝗰𝗼 ⤳ </b>  <code>{bank}</code>\n"
        message += f"<b>⌮ 𝗣𝗮𝗶𝘀 ⤳ </b>  <code>{country_name} [{country_flag}]</code>\n"
        message += "━━━━━━━━━━━━━━\n"
        message += f"<b>⌮ 𝐄𝐱𝐭𝐫𝐚 ⤳ </b>  <code>{card_number}xxxx|{month}|{year}|rnd</code>\n"
        message += f"⌖  <b>BY</b> ⤳ <b>DevilMods</b>[Free CC]\n"
        message += "━━━━━━━━━━━━━━\n"
